...
const SPECIALTIES = [
  ...
  'Stress Management', 'Self-Esteem', 'Life Transitions', 'LGBTQ+ Issues', 'Addiction',
  'Eating Disorders', 'OCD', 'ADHD', 'Chronic Illness', 'Family Conflict',
];
const THERAPY_TYPES = [
  'CBT', 'DBT', 'EMDR', 'Psychodynamic', 'Mindfulness-Based', 'Solution-Focused',
  'Narrative Therapy', 'ACT', 'Somatic Therapy', 'Couples Therapy', 'Family Therapy',
];
const INSURANCES = [
