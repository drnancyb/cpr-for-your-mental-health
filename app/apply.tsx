...
const SPECIALTIES_OPTIONS = ['Anxiety', 'Depression', 'Trauma', 'PTSD', 'Grief', 'Relationships', 'Addiction', 'ADHD', 'OCD', 'Eating Disorders', 'Anger Management', 'Stress'];
const THERAPY_TYPES_OPTIONS = ['CBT', 'DBT', 'EMDR', 'Psychodynamic', 'Mindfulness-Based', 'Solution-Focused', 'ACT', 'Narrative Therapy', 'Somatic Therapy'];
